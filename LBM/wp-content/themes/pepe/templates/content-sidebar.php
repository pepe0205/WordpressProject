    ...
    <?php 
        ...
        foreach ($categories as $category) { ?>
            <li data-view-id="main_navigation_item" class="MenuItem-sc-181aa19-0 cOJYFK">
                <a href="<?php echo get_term_link($category->slug, 'product_cat') ?>" rel="" class="MenuItem__MenuLink-sc-181aa19-1 bDtEiz"><span class="icon-wrap"><i class="icon-main-menu-global lv1-icon tikicon"></i></span><span class="text abc"> <?php echo $category->name; ?> </span></a>
