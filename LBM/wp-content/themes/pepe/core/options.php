    ...
    class Pepe_Theme_Options
    {
        ...
        **/
        public function setSections()
        {
            ...
            $this->sections[] = array(
                'title' => __('Danh mục', 'thachpham'),
                'desc' => __('Đổi hiển thị danh mục', 'thachpham'),
                'icon' => 'el-icon-file-edit',
                'fields' => array(
                    array(
                        'id' => 'change-category',
                        'type' => 'select',
                        'title' => __('Chọn danh mục', 'redux-framework-demo'),
                        'subtitle' => __('Đổi danh mục hiển thị lên Home', 'redux-framework-demo'),
                        'data' => 'categories',
                        'args' => array(
                            'type' => 'product',
                            'child_of' => 0,
                     ...
                     array(
                        'id' => 'change-category-2',
                        'type' => 'select',
                        'title' => __('Chọn danh mục thứ 2', 'redux-framework-demo'),
                        'subtitle' => __('Đổi danh mục hiển thị lên Home', 'redux-framework-demo'),
                        'data' => 'categories',
                        'args' => array(
                            'type' => 'product',
