...
<html class="no-js" lang="vi">
    <head>
        ...
        <style data-styled="iLqNYh DGJYL jFkAwY keqhba cWvEXu fodycE eyPsbF RQjYA bKdpdw emAIGI chNgxQ cSjaat kbxFvK kfetWg iPNSVE ciGWvl eUnWAD ieXBRV frgVSd dXrTmU lneWsb dFYIFY gGRKbG lnmTTi gysDqQ cbYxcp cVRwHa dYkBsI eqGBml fpkFKZ bsRyYf gUdFI gjPwhU bDWZEC gehNXH jLgptr cGQBXq hxjWDx jojljn PZSel fFfYcb jTePei kOJvlh USGjt fhRZBX kDQVrI dmwCoo bxMFIu cqfajw duIWIs bXucsW cWQRZu iAGfjm cEIqfF fLaIdA eyUWwv hnnefw gydRzF" data-styled-version="4.4.1">
    ...
    <div class="Container-itwfbd-0 jFkAwY">
        <div class="Middle__Wrap-vop1h1-0 cSjaat">
            ...
            <div data-view-id="header_user_shortcut" class="Userstyle__Root-sc-6e6am-0 dXrTmU">
                ...
                <div data-view-id="header_user_shortcut_cart" class="Userstyle__CartItem-sc-6e6am-13 gjPwhU">
                    <a href="http://localhost:88/LBM/gio-hang/">
                        <div class="Userstyle__Item-sc-6e6am-1 dFYIFY"><i class="tikicon icon-cart"></i><span class="Userstyle__ItemText-sc-6e6am-2 gGRKbG">Giỏ hàng<span class="Userstyle__ItemCartQty-sc-6e6am-4 bDWZEC">0</span></span></div>
                    </a>
                </div>
            </div>
        </div>
