                                ...
                                <div class="indexstyle__AddToCart-qd1z2k-7 fZaWsF add-to-cart">
                                    <div class="qty-and-message">
                                        <div class="QualityInput__Wrapper-sc-15mlmyf-0 iyaBQp">
                                            ...
                                            <div class="group-input"><button><img src="https://frontend.tikicdn.com/_desktop-next/static/img/pdp_revamp_v2/icons-remove.svg"/></button><input type="text" value="1" class="input"/><button><img src="https://frontend.tikicdn.com/_desktop-next/static/img/pdp_revamp_v2/icons-add.svg"/></button></div>
                                        </div>
                                    </div>
                                             ...
                                             $('.btn-add-to-cart').click(function(){
                                                ...
                                                data : {
                                                    action : "quantity",
                                                     ...
                                                     stock : <?php echo $product->get_stock_quantity();?>,
                                                    checkCart: <?php echo $qty; ?> 
                                                },
                                                beforeSend: function() {
                                                    $('.spinner').show();
                                                },
                                                ...
                                                if(data == "out-stock"){  
                                                   ...
                                                   alert("Mặt hàng này chỉ còn <?php echo $product->get_stock_quantity();?> sản phẩm");
                                                   location.reload();
                                                  }else{
                                                   
                                                    $('.fhQCQR').css('display','block');
