                                                        ...
                                                        <div class="cart-products__content">
                                                            <div class="cart-products__content--inner">
                                                                <div class="cart-products__desc">
                                                                    ...
                                                                    <p class="cart-products__actions"><span class="cart-products__del" onclick="window.location.href='<?php echo $cart_item_remove_url; ?>';">Xóa</span><span class="cart-products__buy-later">Để dành mua sau</span></p>
                                                                </div>
